...
export const Blog: React.FC = () => {
 ...
 <img src={img1} alt="blog" />
        ...
        <Col xs={24} sm={24} md={24} lg={11} xl={11} className="blog__content">
          ...
          <a className="blog__more" href=""  onClick={() => push(`/blog/${blogdata[0].id}`)}>
      ...
      <Row className="blog__Row2" align="middle" gutter={[24, 24]}>
        ...
        <div className="blog__box2"  >
          ...
          <a className="blog__more" href=""  onClick={() => push(`/blog/${blogdata[1].id}`)}
            >
            خواندن مقاله <ArrowLeftOutlined />
          </a>
          </div>
      ...
      <Row justify="center">
        <AppButton className="blog__Button" onclick={() => push(`/blog`)} >مقاله‌های بعدی</AppButton>
      </Row>
    </section>
  );
};
